...
function autocomplete(input, latInput, lngInput) {
	...
	// if someone hits enter on addr field dont submit form
...
function loadPlaces(map) {
	...
	_axios2.default.get('/api/search/near?lat=' + lat + '&lng=' + lng).then(function (res) {
		var places = res.data;
		if (!places.length) {
